...
namespace COL781 {
	namespace OpenGL {
		...
		public:
			...
			// A vertex shader that supports Phong's shading model.
			VertexShader vsPhongShading();

			// A fragment shader that supports Phong's shading model.
			FragmentShader fsPhongShading();
