...
// animation, with or without cloth
...
int main(int argc, char **argv) {
  ...
  glm::mat4 m = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 1.3f, 0.0f));
  if (argc > 1) {
    ...
    float g = -0.98f;
    sheet->setDimensions(100, 40, 0.05f);
  ...
  // chest_c->setScale(glm::vec3(0.4f, 0.4f, 0.4f));
  Cylinder *chest = new Cylinder();
  chest->setDimensions(0.3f, 1.8f, 20, 10);
  chest->init();
  ...
  arm_l_c->setPosition(glm::vec3(0.87f, 0.0f, 0.0f));
  arm_l_c->setRecenter(glm::vec3(0.6f, 0.0f, 0.0f));
  arm_l_c->setRotation(glm::vec3(0.0f, 1.0f, 0.0f));
  arm_l_c->setTimeSteps(
      {{3.0, 0.0}, {4.0, -90.0f}, {6.0, -70.0f}, {7.0, -90.0f}, {9.0, 0.0f}});
  Cylinder *arm_l = new Cylinder();
  arm_l->setDimensions(0.2f, 1.2f, 20, 10);
  arm_l->init();
  arm_l->color = glm::vec3(0.2f, 0.0f, 0.8f);
  arm_l_c->addShape(arm_l, sim);

  ShapeContainer *larm_l_c = new ShapeContainer();
  larm_l_c->setPosition(glm::vec3(0.57f, 0.0f, 0.0f));
  larm_l_c->setRecenter(glm::vec3(0.6f, 0.0f, 0.0f));
  larm_l_c->setRotation(glm::vec3(0.0f, 0.0f, -1.0f));
  larm_l_c->setTimeSteps({{4.0f, 0.0f},
                          {6.0, -120.0f},
                          {7.0, -70.0f},
                          {8.0, -90.0f},
                          {9.0, 0.0f}});
  Cylinder *larm_l = new Cylinder();
  larm_l->setDimensions(0.2f, 1.2f, 20, 10);
  larm_l->init();
  ...
  arm_r_c->setPosition(glm::vec3(-0.87f, 0.0f, 0.0f));
  arm_r_c->setRecenter(glm::vec3(-0.6f, 0.0f, 0.0f));
  arm_r_c->setRotation(glm::vec3(0.0f, 1.0f, 0.0f));
  arm_r_c->setTimeSteps(
      {{3.0, 0.0f}, {4.0, 90.0f}, {6.0, 70.0f}, {7.0, 90.0f}, {9.0, 0.0f}});
  Cylinder *arm_r = new Cylinder();
  arm_r->setDimensions(0.2f, 1.2f, 20, 10);
  arm_r->init();
